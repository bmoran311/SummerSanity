<table class="w-full text-xl">
    <thead>
        <tr>
            <th class="px-2 py-2 text-left uppercase text-gray-500 tracking-wider" style="font-family: 'Overpass', sans-serif;">Camper Name</th>
            <th class="px-2 py-2 text-left uppercase text-gray-500 tracking-wider" style="font-family: 'Overpass', sans-serif;">Birth Date</th>
    ...
    <tbody class="bg-white shadow-md rounded-lg">
        ...
        <tr class="border-b border-gray-200 text-3xl">
            <td class="px-2 py-2">{{ $camper->first_name }} {{ $camper->last_name }}</td>
            <td class="px-2 py-2">{{ \Carbon\Carbon::parse($camper->birth_date)->format('F j Y') }}</td>
            <td class="px-2 py-2 flex items-center justify-end">
